...
let savednote = document.getElementById('n');
...
editBtn.className= "btn btn-warning m-3"
    ...
    savednote.appendChild(newnote);
    savednote.appendChild(editBtn);
    savednote.appendChild(deleteBtn);
    savednote.className="card";
    note.value="";
    ...
    note.value= newnote.textContent;
    newnote.remove();
        deleteBtn.remove();
        editBtn.remove();
